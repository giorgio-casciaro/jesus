...
const log = (msg, data) => { console.log('\n' + JSON.stringify(['LOG', 'JESUS CLIENT HTTP', msg, data])) }
const debug = (msg, data) => { if (process.env.debugJesus)console.log('\n' + JSON.stringify(['DEBUG', 'JESUS CLIENT HTTP', msg, data])) }
const error = (msg, data) => { console.log('\n' + JSON.stringify(['ERROR', 'JESUS CLIENT HTTP', msg, data])); console.error(data) }
